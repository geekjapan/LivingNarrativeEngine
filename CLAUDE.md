...
This project is indexed by GitNexus as **LivingNarrativeEngine** (3808 symbols, 5315 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
