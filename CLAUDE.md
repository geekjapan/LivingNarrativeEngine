...
This project is indexed by GitNexus as **LivingNarrativeEngine** (6268 symbols, 11714 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
