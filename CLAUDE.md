...
This project is indexed by GitNexus as **LivingNarrativeEngine** (3802 symbols, 5309 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
