...
def build_narrator_context(context: TurnContext, resolved_events: list[Event]) -> NarratorContext:
    ...
    reader_visible_events = [event for event in resolved_events if is_reader_visible_event(event)]
