...
This project is indexed by GitNexus as **LivingNarrativeEngine** (5679 symbols, 11176 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
