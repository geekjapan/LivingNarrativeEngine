...
This project is indexed by GitNexus as **LivingNarrativeEngine** (5291 symbols, 10240 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
