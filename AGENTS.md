...
This project is indexed by GitNexus as **LivingNarrativeEngine** (6015 symbols, 11473 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
