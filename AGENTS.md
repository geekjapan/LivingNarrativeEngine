...
This project is indexed by GitNexus as **LivingNarrativeEngine** (5821 symbols, 11370 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
