...
This project is indexed by GitNexus as **LivingNarrativeEngine** (4268 symbols, 6390 relationships, 143 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
