...
This project is indexed by GitNexus as **LivingNarrativeEngine** (6428 symbols, 12009 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
