...
This project is indexed by GitNexus as **LivingNarrativeEngine** (3860 symbols, 5416 relationships, 114 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
