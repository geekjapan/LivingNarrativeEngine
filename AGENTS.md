...
This project is indexed by GitNexus as **LivingNarrativeEngine** (3930 symbols, 5561 relationships, 112 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
